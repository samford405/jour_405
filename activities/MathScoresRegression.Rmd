...
**There is a slight positive correlation but not much. Along with all the schools with 100 Farms percentage and math test scores are slight over the median or below**
...
**Its a bit useful it shows the min, max and median but not much else**
...
**With fewer students, there is more oppurtunity to for students to learn so it would make sense for them to do better on the math test. **
