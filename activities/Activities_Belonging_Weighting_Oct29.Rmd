...
**YOUR NAME HERE:** Sam Ford, Miguel
...
**The scales were not designed to be objective according to the appendix, meaning with different perspectives.
...
1. What is the range of weights in this dataset? **the lowest is 0.23 and the highest being 3.04**

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Less of a significance and more of a significance.**

3. Why might some respondents be weighted more heavily than others? **in order to match the population**
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **Write your answer here: The rarely/never NO made the most difference with a percentage of 2 percent**

2. How might these differences affect reporting on likely voter turnout? **Write your answer here: I think the largest difference in the rarely/never category would likely affect voter turnout**

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **Write your answer here:The rarely/never no group is rarely represented**
