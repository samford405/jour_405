...
Read data likes its objective and your gonna have assumptions and get a skewed data
...
**Your answer**: if you use one neighborhood to describe one city that would be inaccurate. Another example is house pricing where you have houses that are nice and reasonably priced and having that lower house will increase. A reporter could make a story on how maybe the safety of a city to see if its really getting safer or just one area.
...
**Answer**: Maryland volleyball is in the 95th percentile
...
**Answer**: Its skewed to the right. Most of the values are clustered around the mean so the standard deviation determines the variation
