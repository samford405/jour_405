...
**Task 3: Write your answer here: The means for instance were kinda stereotypical with community having the lowest, public in the middle, and private in the highest.**
...
Yes it passes all of the thresholds when we run the ANOVA test
2. Which specific college types differ from each other?
Commmunity colleges differ the public and private
3. How large are these differences? Sat scores 366.96 points for private which is higher then community, while public colleges are 292.55
