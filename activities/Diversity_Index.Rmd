...
**Langley Park looks very diverse between black and whites along with the asian and native minorities**
...
**Summerville has the highest race probabilty. Its in PG county Maryland which a very diverse county**
...
**Maryland’s lowest Hisp_Prob cities tend to be smaller, more rural, and less diverse, with relatively little Hispanic presence compared to the state’s urban core.**
...
**From the Diversity Index, Langley Park, Wheaton, Adelphi.Lake Shore has the least**
...
**Two Marylands: The Split of Two Communities in the State’s Seemingly Uneven Diversity Landscape

Lede:
Maryland is one of the nation’s most diverse states, but new data show that its diversity isn’t evenly shared. In places like Langley Park, Wheaton, and Adelphi, nearly every neighbor likely has roots in a different part of the world places where it’s almost guaranteed two randomly chosen residents will be from different racial or ethnic groups. But travel just 40 miles east to Lake Shore, and the odds of that happening drop sharply, reflecting a community that remains far less mixed even as Maryland’s overall population grows more varied.

I’d report it out by talking to people who are demographers at the Maryland Department of Planning to explain migration and housing trends driving diversity differences.Community leaders and longtime residents in both Langley Park/Wheaton and Lake Shore to capture how diversity shapes daily life, schools, and businesses**
