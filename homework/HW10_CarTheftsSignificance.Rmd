...
**WRITE ANSWERS HERE:For the most part going down with ver slight trends of going back up but seems to trend straight down**
...
- What does the 95% confidence interval show here? **WRITE ANSWER HERE:The 95% confidence interval shows the range where the true average number of monthly car thefts likely falls, with 95% certainty**

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:The mean and shaded confidence band show what’s typical — most months fall within that range.**

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. **WRITE ANSWER HERE:Car Thefts in Prince George’s County Have Declined but Remain Within Typical Levels**
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **WRITE ANSWER HERE:the apparent decrease in car thefts could be due to random variation.If the p-value is less than 0.05, then the difference is significant, and we reject the null hypothesis, indicating a real change between the two periods.**

How would you revise your headline from Task 6, if at all? What would you tell your editor, and what would you expect her to ask you? **WRITE ANSWER HERE: Car Thefts Appear to Decline, but Change Isn’t Statistically Significant. The data suggest a downward trend, but the t-test shows it’s not significant yet, we’d need more months of data to confirm a real shift.**
