...
```{r}
DJIA_data <- read.csv("https://raw.githubusercontent.com/dwillis/jour405/refs/heads/main/data/gdp_djia.csv")
```
...
There is a strong positive correlation between the DJIA and GDP. As GDP increases, the DJIA also tends to rise. The scatterplot shows an upward trend, meaning higher GDP values are generally linked with higher DJIA values.
