...
**College-Educated Adults Most Likely to Plan to Vote, Survey Shows**
...
**The numbers changed a little after weighting. People with less education showed a bigger increase in “yes” answers.**

2. Why might the weighted results be considered more accurate than the unweighted results?

**Weighted results are more accurate because they fix imbalances in who took the survey, making it better match the real population.**
...
**People with a high school education or less had the biggest change between weighted and unweighted results.**
...
**If the numbers change a lot after weighting, I’d focus on the weighted data and explain why it’s more reliable.**
...
**I’d want to know what factors the weights were based on, like age, race, or education and how they were made to match the population.**
