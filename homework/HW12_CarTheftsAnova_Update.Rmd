...
theft_data <- theft_data |>
  mutate(
    ...
    theft_rate = (population / total) * 100000,
...
**WRITE YOUR ANSWER HERE**: Theft rates rose sharply in 2023, about triple the pre-spike levels, then dropped again afterward. It shows a clear but temporary spike. The median rate nearly tripled from the 22.2 in the pre-spike to 58.1 in the spike year but the sample sizes varied a great deal, with 71 observations in pre-spike versus 12 in the spike year.
...
**The chart shows a big jump in thefts during 2023 and a drop after.
Better title: "Car Thefts Jumped in 2023 Before Falling Again"**
...
- **Null Hypothesis (H0)**: Mean theft rates are the same across all time periods.

- **Alternative Hypothesis (H1)**: Mean theft rates are different between at least two periods.
...
**Yes, the ANOVA shows real and significant differences. The spike year’s average rate is much higher than the others.**
...
**Tukey’s test shows 2023 is higher than both pre- and post-spike periods, but pre- and post-spike aren’t different.
Headline: “Car Thefts Spiked in 2023, Then Returned to Normal.”
Lede: Theft rates jumped in 2023 but fell back to pre-spike levels the next year.**