...
ANSWER HERE: Most of the categories reflect property-related or vehicle-related crimes. Some involve accidents, while others are break-ins or different forms of theft. What stands out most to me are the shooting and assault statistics, since they differ from the rest. They are also especially concerning and represent the kinds of crimes most citizens want to see reduced.
...
ANSWER HERE: October shows the highest average number of crimes, which I believe may be linked to the return of college students—leading to more accidents or vehicle break-ins. I also noticed that crime tends to be more frequent during the summer months.
...
ANSWER HERE: What stood out most was the large number of vehicle-related robberies. I also observed an increase in assault shootings, though the sample size for those incidents is relatively small.
...
ANSWER HERE: Data from Prince George's County shows that vehicle robberies experienced the largest increase. In July alone, there was a 64% rise, with 41 reported incidents. Assault shootings also rose by 34% in both July and August, with 21 incidents each month.
